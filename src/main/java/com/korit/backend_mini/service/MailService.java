...
public class MailService {
    ...
    public ApiRespDto<?> sendMail(PrincipalUser principalUser) {
        ...
        if (!hasTempRole) {
            return new ApiRespDto<>("failed", "인증이 완료된 계정입니다.", null);
        }
        ...
        return new ApiRespDto<>("success", "인증 이메일이 전송되었습니다. 이메일을 확인해주세요.", null);
    }
